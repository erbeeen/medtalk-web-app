...
export default function logger(
  ...
  res.on("finish", () => {
    ...
    const requestLog = `[${timeString}] ${req.protocol.toUpperCase()}${req.httpVersion} ${req.method} ${req.originalUrl} ${res.statusCode} ${res.statusMessage} - ${duration.toFixed(2)} ms`;
