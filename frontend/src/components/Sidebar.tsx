...
export default function Sidebar() {
  return (
    ...
    <div className="sidebar bg-light-800/5 dark:bg-gray-700/40 font-open-sans text-light-text dark:text-dark-text">
      <Link to="/" className="sidebar-link hover:bg-800 dark:hover:bg-primary-dark/20">
